...
namespace TestTabelaResponivaBoostrap.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        {
            foreach(var item in arquivos.FormFiles)
            {
        ...
        public async Task<IActionResult> File(FileModel fileModel)
        {
            ...
            // Agora, 'base64String' cont�m a representa��o Base64 do arquivo
            // Fa�a o que quiser com 'base64String', como salv�-lo no banco de dados ou us�-lo em outro lugar.
